...
Authors: Daniel L., Tiana T., Drew P., Jason M., Joshua J., Matthew C., Tatiana S.

Please review our full analysis in our [Code Folder](https://github.com/Loehnert12/Activities/tree/main/Data) as well as our [presentation slides](<Data/Savvy Coders Class Project December 2023.pptx>)
...
![Alt text](<Images/Global Sales.PNG>)
...
![Alt text](<Images/State Conclusion..PNG>) ![Alt text](<Images/State Conclusion 2.PNG>)
### City-Level Analysis
